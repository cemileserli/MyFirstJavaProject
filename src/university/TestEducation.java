...
public class TestEducation {
    public static void main(String[] args) {
        ...
        professor1.coursesGiven = new Course[7];
        ...
        System.out.println("Name of student student1's first course's professor's department is " + student1.coursesTaken[0].department.name);
